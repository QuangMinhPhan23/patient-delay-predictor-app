...
# Mount static files for evaluation metrics images
if os.path.exists('evaluation_metrics'):
    app.mount("/evaluation_metrics", StaticFiles(directory="evaluation_metrics"), name="evaluation_metrics")
...
async def model_info():
    ...
    try:
        ...
        # Check if evaluation metrics images exist
        evaluation_images = {}
        image_names = [
            'roc_curve.png',
        ...
        for img in image_names:
            img_path = os.path.join('evaluation_metrics', img)
            if os.path.exists(img_path):
                evaluation_images[img.replace('.png', '')] = f"/evaluation_metrics/{img}"
